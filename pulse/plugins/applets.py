...
class OafServerHandler (object):
    ...
    def post_process (self, **kw):
        """
        Update other information about applets in a module.

        This function will locate icons for applets.  This happens in
        post-processing to allow the images plugin to find all images.
        """
        images = self.scanner.get_plugin (pulse.plugins.images.ImagesHandler)
        for applet, applet_icon in self.appleticons:
